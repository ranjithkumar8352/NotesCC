...
def main():
    ...
    courseList = []
    courseIdList = []
    courseList.append({'courseName':'DATA STRUCTURE', 'courseCode':'DS', 'professorName':'Rajbeer Kaur', 'colour':'BLUE', 'batchNames':['2014'], 'branchNames':['CSE', 'CCE'], 'sectionNames':['A'], 'semester':'Odd', 'date':['1', '2', '3'], 'startTime':['10:00', '11:00', '12:00'], 'endTime':['11:00', '12:00', '13:00'], 'profileId':profileIdList[0], 'collegeId':collegeIdList[0], 'elective':'0'})
    courseList.append({'courseName':'MATHS', 'courseCode':'M1', 'professorName':'Ajit Patel', 'colour':'RED', 'batchNames':['2014'], 'branchNames':['CSE', 'CCE', 'MME'], 'sectionNames':['A'], 'semester':'Odd', 'date':['2', '3', '4'], 'startTime':['12:00', '13:00', '14:00'], 'endTime':['13:00', '14:00', '15:00'], 'profileId':profileIdList[0], 'collegeId':collegeIdList[0], 'elective':'0'})
    courseList.append({'courseName':'Optimization Techniques', 'courseCode':'OT', 'professorName':'Manish Garg', 'colour':'YELLOW', 'batchNames':['2014'], 'branchNames':['CSE', 'ECE'], 'sectionNames':['A'], 'semester':'Odd', 'date':['1','3', '5'], 'startTime':['11:00', '14:00', '09:00'], 'endTime':['13:00', '15:00', '10:00'], 'profileId':profileIdList[2], 'collegeId':collegeIdList[0], 'elective':'1'})
    courseList.append({'courseName':'MICRO ECONOMICS', 'courseCode':'ECO', 'professorName':'Surinder Nehra', 'colour':'VIOLET', 'batchNames':['2014'], 'branchNames':['CSE', 'CCE', 'MME', 'ECE'], 'sectionNames':['A'], 'semester':'Odd', 'date':['1', '2'], 'startTime':['13:00', '14:00'], 'endTime':['14:00', '15:00'], 'profileId':profileIdList[1], 'collegeId':collegeIdList[0], 'elective':'0'})
    courseList.append({'courseName':'INTRODUCTION TO C', 'courseCode':'ITC', 'professorName':'Preety Singh', 'colour':'GREEN', 'batchNames':['2014'], 'branchNames':['CSE'], 'sectionNames':['A'], 'semester':'Odd', 'date':['3', '4', '5'], 'startTime':['15:00', '15:00', '12:00'], 'endTime':['16:00', '16:00', '13:00'], 'profileId':profileIdList[2], 'collegeId':collegeIdList[0], 'elective':'0'})
